...
`dms/alttab.kdl` is generated by DMS and must not be hand-edited. Monitor
output profiles and DMS's unreferenced generated `dms/input.kdl` stay local to
each computer; the managed `myunix/touchpad.kdl` carries portable touchpad
behavior. DMS plugin state, caches, wallpaper paths, device pins and
paired-phone data are not exported. [[../records/2026-07-14-niri-dms-cangjie|The Cangjie incident record]]
